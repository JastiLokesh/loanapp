...
class LoansState  extends State<Loans>{
  ...
  async{
    var url = Uri.parse("http://10.0.2.2:8091/api/GetCustomerLoanDetails/"+"$id");
    print(url);
  ...
  async{
    var url = Uri.parse("http://10.0.2.2:8091/api/getIntrestrateType");
  ...
  async{
    var url = Uri.parse("http://10.0.2.2:8091/api/getPaymentFrequency");
    var data = await http.post(url);
    var jsonData = json.decode(data.body);
    print(jsonData);
