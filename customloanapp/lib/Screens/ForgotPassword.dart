...
import 'package:customloanapp/Screens/Login.dart';
...
Future<CustomerModel?> updateCustomerDetails(
    { required String id,required String password, required BuildContext context,})
async{
  try{
    var url = Uri.parse("http://10.0.2.2:8091/api/updateCustomerDetails");
...
class forgotPasswordState extends State<ForgotPassword> {
  ...
  validate() {
    ...
    if (ctr == 0 && ctr1 == 0 && confirmpassflag==0) {
      ...
      {
        updateCustomerDetails(id: phoneNumberController.value.text, password: passwordController.value.text, context: context);
