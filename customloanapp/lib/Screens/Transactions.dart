...
class transactionsState extends State<Transactions> {
  ...
  async{
    ...
    print(date);
    var url = Uri.parse("http://10.0.2.2:8091/api/statement-summary/"+"${date}");
  ...
  async{
    ...
    String date = dropdownvalue.substring(4,)+ "-" +month1+"-"+day1;
    var url = Uri.parse("http://10.0.2.2:8091/api/statementCreditTransactions/"+"${date}/"+"${statusModel.loanId}");
    var data = await http.post(url);
    var jsonData = json.decode(data.body);
    print(jsonData);
  ...
  async{
    ...
    String date = dropdownvalue.substring(4,)+ "-" +month1+"-"+day1;
    var url = Uri.parse("http://10.0.2.2:8091/api/statementDebitTransactions/"+"${date}/"+"${statusModel.loanId}");
    var data = await http.post(url);
    var jsonData = json.decode(data.body);
    print(jsonData);
    StatementTransactions details = new StatementTransactions();
  ...
  async{
    ...
    String date = dropdownvalue.substring(4,)+ "-" +month1+"-"+day1;
    var url = Uri.parse("http://10.0.2.2:8091/api/statementTransactions/"+"${date}/"+"${statusModel.loanId}");
    var data = await http.post(url);
    var jsonData = json.decode(data.body);
    print(jsonData);
  ...
  async{
    var url = Uri.parse("http://10.0.2.2:8091/api/UnbilledCreditTransactions/"+"${statusModel.loanId}");
    var data = await http.post(url);
    var jsonData = json.decode(data.body);
    print(jsonData);
    StatementTransactions details = new StatementTransactions();
  ...
  async{
    var url = Uri.parse("http://10.0.2.2:8091/api/UnbilledDebitTransactions/"+"${statusModel.loanId}");
    var data = await http.post(url);
    var jsonData = json.decode(data.body);
    print(jsonData);
    StatementTransactions details = new StatementTransactions();
  ...
  async{
    ...
    var url = Uri.parse("http://10.0.2.2:8091/api/statementdates/"+"${statusModel.loanId}");
