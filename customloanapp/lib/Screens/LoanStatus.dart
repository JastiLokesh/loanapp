...
import '../Model/LoanStatusModel.dart';
import '../Model/PaymentModel.dart';
import '../Model/RemainingPaymentModel.dart';
import '../Model/StatementDetails.dart';
import '../Model/StatementTransactions.dart';
import '../Model/TermWiseDetails.dart';
...
class LaonStatusState  extends State<LoanStatus>{
  ...
  Widget build(BuildContext context) {
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/getLoanDetails/"+"${model.customerId}/"+"${model.loanType}/"+"${model.mobilenumber}");
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/getPaymentDetails/"+"${model.loanId}");
      var data = await http.get(url);
      var jsonData = json.decode(data.body);
      print(jsonData);
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/totalAmounts/"+"${model.loanId}");
    ...
    async{
      ...
      var url = Uri.parse("http://10.0.2.2:8091/api/statementdates/"+"${activeLaonsModel.loanId}");
      var data = await http.get(url);
      var jsonData = json.decode(data.body);
      print(" loan id ${activeLaonsModel.loanId}");
      print(jsonData);
    ...
    async{
      ...
      print("loan id" + "${activeLaonsModel.loanId}");
      var url = Uri.parse("http://10.0.2.2:8091/api/nextduedate/"+"${activeLaonsModel.loanId}/"+"${loanmodel.nextTerm}");
      var data = await http.post(url);
      var jsonData = json.decode(data.body);
      print(" loan id ${activeLaonsModel.loanId}");
      print(jsonData);
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/nextduedate/"+"${activeLaonsModel.loanId}");
      var data = await http.post(url);
      var jsonData = json.decode(data.body);
      print(jsonData);
      double model = 0.00;
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/termWiseDetails/1");
      var data = await http.post(url);
      var jsonData = json.decode(data.body);
      print(jsonData);
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/UnbilledCreditTransactions/"+"${activeLaonsModel.loanId}");
      var data = await http.post(url);
      var jsonData = json.decode(data.body);
      print(jsonData);
    ...
    async{
      var url = Uri.parse("http://10.0.2.2:8091/api/UnbilledDebitTransactions/"+"${activeLaonsModel.loanId}");
      var data = await http.post(url);
      var jsonData = json.decode(data.body);
      print(jsonData);
      StatementTransactions details = new StatementTransactions();
    ...
    async{
      ...
      var url = Uri.parse("http://10.0.2.2:8091/api/statementTransactions/"+"${date}/"+"${activeLaonsModel.loanId}");
      var data = await http.post(url);
      var jsonData = json.decode(data.body);
      print(jsonData);
