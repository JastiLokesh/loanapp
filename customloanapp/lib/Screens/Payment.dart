...
import '../Model/UnbilledTransactionModel.dart';
...
async{
  var url = Uri.parse("http://10.0.2.2:8091/api/saveTransactionDetails");
  try
  {
...
async{
  var url = Uri.parse("http://10.0.2.2:8091/api/updatePaymentSchedule/"+"${amt}");
